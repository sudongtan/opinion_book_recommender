...
def login():
    ...
    <div>
    <input type="radio" id="interested_only" name="mode" value="interested_only">
    <label for="top">interested_only</label>
    </div>

    <div>
    <input type="radio" id="topic" name="mode" value="topic">
    <label for="top">topic</label>
    </div>

    <p><input type=submit value=recommend>
    </form>
    <p> The system recommends {k} books you might be interested in using {mode} mode
    <p> =============
